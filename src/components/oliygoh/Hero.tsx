        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8">
          ...
          <div className="flex-1 flex flex-col justify-center order-2 lg:order-1">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight mb-4">
              {title} <br />
              <span className="text-blue-600 block mt-2 text-2xl lg:text-4xl">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <div className="relative h-64 md:h-80 lg:h-96 w-full rounded-2xl overflow-hidden shadow-lg border border-slate-200 group">
               <img 
                 src={bgImage} 
                 alt={title} 
